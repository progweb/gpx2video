#ifndef __LAYOUT__BOOLEAN_H__
#define __LAYOUT__BOOLEAN_H__
...
namespace layout
{
  ...
  class Boolean : public Node
  {
    ...
    ///
    Boolean(Node *parent, const char *name, Type type, bool mandatory = false);
  ...
  protected:
    ...
    ///
    /// Convert to a double value of the Boolean object
    ///
