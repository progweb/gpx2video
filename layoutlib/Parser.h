...
namespace layout
{
  ...
  public:
    ...
    ///
    /// Get the root Layout object after parsing
    ///
    /// @return the root Layout node (or 0 if not present)
    ///
  ...
  public:
    ...
    ///
    /// @return the root LAYOUT node (or 0 after an error)
    ///
    Layout *parse(std::istream &stream);
