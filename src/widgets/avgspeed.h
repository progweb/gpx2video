...
public:
	...
	static AvgSpeedWidget * create(GPXApplication &app, TelemetrySource *source = NULL) {
		AvgSpeedWidget *widget;

		widget = new AvgSpeedWidget(app, source);
...
private:
	...
	AvgSpeedWidget(GPXApplication &app, TelemetrySource *source);
};
