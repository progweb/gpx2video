...
bool BatteryLevelTextShape::updated(const TelemetryData &data) const {
	if (is_initialized_) {
...
void BatteryLevelTextShape::initialize(cairo_t *cr) {
	if (is_initialized_)
		return;
...
void BatteryLevelTextShape::draw(cairo_t *cr, const TelemetryData &data) {
	char s[128];
