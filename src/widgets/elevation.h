...
/**
 * Elevation chart shape widget
 */

class ElevationChartShape : public ChartShape {
public:
	virtual ~ElevationChartShape() {
		clear();
	}

	static ElevationChartShape * create(VideoWidget *widget) {
		ElevationChartShape *shape;

		shape = new ElevationChartShape(widget->theme(), widget);
...
private:
	...
	ElevationChartShape(VideoWidget::Theme &theme, VideoWidget *widget) 
		: ChartShape(theme)
		, bg_buf_(NULL)
		, fg_buf_(NULL)
		, widget_(widget) {
...
public:
	...
	static ElevationWidget * create(GPXApplication &app, TelemetrySource *source = NULL) {
		ElevationWidget *widget;

		widget = new ElevationWidget(app, source);
	...
	void setShape(VideoWidget::Shape type) {
		...
		case VideoWidget::ShapeChart:
			shape_ = ElevationChartShape::create(this);
			break;
...
private:
	...
	ElevationWidget(GPXApplication &app, TelemetrySource *source);
};
