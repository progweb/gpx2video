...
/**
 * Cadence text & icon shape widget
 */
...
public:
	...
	static CadenceTextShape * create(VideoWidget *widget) {
		CadenceTextShape *shape;

		shape = new CadenceTextShape(widget);
	...
	OIIO::ImageBuf * prepare(bool &is_update) {
		...
		if (with_picto)
			this->drawImage(bg_buf_, widget_->border(), widget_->border(), "./assets/picto/DataOverlay_icn_cadence.png", VideoWidget::ZoomFit);
...
private:
	...
	CadenceTextShape(VideoWidget *widget) 
...
public:
	...
	void setShape(VideoWidget::Shape type) {
		...
		default:
			shape_ = CadenceTextShape::create(this);
			break;
		}
	}
