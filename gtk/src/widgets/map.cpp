...
void GPX2VideoMapWidgetSettingsBox::update_content(void) {
	...
	image->set(((Map *) widget_->widget())->getIconFilename(settings.icon(MapSettings::IconStart), MapSettings::IconStart));
	...
	image->set_pixel_size(24);
	image->set(((Map *) widget_->widget())->getIconFilename(settings.icon(MapSettings::IconEnd), MapSettings::IconEnd));
	...
	image->set_pixel_size(24);
	image->set(((Map *) widget_->widget())->getIconFilename(settings.icon(MapSettings::IconPosition), MapSettings::IconPosition));
...
void GPX2VideoMapWidgetSettingsBox::create_popover(Gtk::MenuButton *menubutton, MapSettings::Icon type) {
	...
	if (index == MapSettings::IconDefault)
		...
		// Icon not found!
		if (index == MapSettings::IconUserFile) {
			// Auto append
