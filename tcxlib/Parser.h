#ifndef __TCX__PARSER_H__
#define __TCX__PARSER_H__

//==============================================================================
//
//           Parser - the parser class in the tcx library
//
...
namespace tcx
{
  ...
  public:
    ...
    ///
    /// Get the root TCX object after parsing
    ///
    /// @return the root TCX node (or 0 if not present)
    ///
    TCX *root() const { return _root; }
  ...
  public:
    ...
    ///
    /// @return the root TCX node (or 0 after an error)
    ///
    TCX *parse(std::istream &stream);
